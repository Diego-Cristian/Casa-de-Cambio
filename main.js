...
function convertir() {
	...
	if (document.getElementById("uno").checked) {
		...
		alert("Tienes que completar el formulario");//Aqui al final se le instruye al codigo que en caso el usuario no haber seleccionado ninguna opcion o no haber ingresado un valor se le informe que tiene que completar el formulario.		
	}
}
